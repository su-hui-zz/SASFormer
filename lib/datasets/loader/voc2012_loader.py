...
class VOC2012Loader(data.Dataset):
    def __init__(self, root_dir, split, aug_transform=None, dataset=None,
        ...
        root_voc = os.path.join(root_dir,'')  # root_dir = /data1/
    ...
    def get(self, index):
        ...
        # if not os.path.exists(ds.images[idx]):
        #     ori_name = os.path.join('/data1/VOCdevkit/VOC2012/JPEGImages', os.path.basename(ds.images[idx]))
        #     shutil.copy(ori_name, ds.images[idx])
        #     print("copy ", os.path.basename(ds.images[idx]))
        #     #ds.images[idx] = os.path.join('/data1/VOCdevkit/VOC2012/JPEGImages', os.path.basename(ds.images[idx]))
