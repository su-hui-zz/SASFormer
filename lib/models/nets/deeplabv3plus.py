...
class DeepLabV3Plus(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.backbone(x)          # [bz,128,256,256], [bz,128,128,128], [bz,256,128,128], [bz,512,64,64], [bz,1024,32,32], [bz,2048,32,32], 
        high_feat = self.aspp(x[-1])  # [bz, 256, 32, 32]
        low_feat = x[2]               # [bz, 256, 128, 128]

        main_pred, feat = self.decoder(high_feat, low_feat)  # main_pred-[bz,21,128,128], feat-[bz,256,128,128]
        outs = []
